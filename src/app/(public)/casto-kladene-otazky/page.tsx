...
import { getGeneralFaq, getCourseFaqGrouped, getAllCourses } from "@/db/queries";
...
export default async function FAQPage() {
  const { general: faqItems, byCourse } = await getCourseFaqGrouped();
      ...
      <section className="border-b border-border py-20">
        <div className="container">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8">
              <CourseFAQ items={mesicniId ? (byCourse[mesicniId] || []) : []} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-border py-20">
        <div className="container">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8">
              <CourseFAQ items={dvoutydeniId ? (byCourse[dvoutydeniId] || []) : []} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-border py-20">
        <div className="container">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8">
              <CourseFAQ items={jednodenekId ? (byCourse[jednodenekId] || []) : []} />
            </div>
          </div>
        </div>
      </section>
