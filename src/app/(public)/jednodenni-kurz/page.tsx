...
import { getCourseWithProgram, getAllInstructors, getAllTestimonials, getGeneralFaq, getCourseFaq } from "@/db/queries";
...
export async function generateMetadata(): Promise<Metadata> {
  const course = await getCourseWithProgram("jednodenni-kurz");
  return {
...
export default async function JednodennikurzPage() {
  const course = (await getCourseWithProgram("jednodenni-kurz"))!;
