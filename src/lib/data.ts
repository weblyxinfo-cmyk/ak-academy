...
export const instructors: Instructor[] = [
  {
    ...
    focus: "Maximální preciznost, ostrost detailů a čisté přechody (fade)",
    bio: "Barber z Ameriky – Philadelphia. Specialista na precizní fade techniky a čisté přechody s 20 lety zkušeností v oboru.",
  ...
  },
  {
    ...
    focus: "Moderní střihy, fade techniky, práce s vousy a styling",
    bio: "Zkušený barber se zaměřením na moderní střihy a fade techniky. Specialista na práci s vousy a styling.",
  ...
  },
  {
    ...
    focus: "Precizní střihy, technika přechodů, detailní práce a profesionální přístup",
    bio: "Barber s 11 lety praxe zaměřený na precizní střihy a techniku přechodů. Známý svým detailním přístupem a profesionalitou.",
